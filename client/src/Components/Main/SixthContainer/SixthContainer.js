  ...
  return (
    <div className="sixthContainer">
      ...
      <div className="advantagesContainer">
        ...
        />
        <Advantage
          title="Для чего в лечении применяется фотопротокол?"
          content="Фотопротокол позволяет провести анализ лица и зубного ряда, отследить ситуацию до, в процессе лечения и после. Убедиться в полученном результате и запротоколировать все этапы лечения."
