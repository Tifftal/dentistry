        ...
        <section className="second-section-wrapper">
            {isMobile ? (
                ...
                <div className="secondContainer">
                    ...
                    <div className="box3">
                        <img src="../../IMG/DSC02747-2.webp" alt="Таценко Елена Геннадьевна" />
                    ...
                    <div className="box4">
                        <img src="../../IMG/Мосесова А.С.webp" alt="Мосесова Анжелика Сержевна" />
                    ...
                    <div className="box5">
                        <img src="../../IMG/DSC02705-2.webp" alt="Куашева Фатима Магометовна" />
