...
const AdminComment = (props) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://formulaulybki.ru/api/comments/getAllForAdmin");
  ...
  const handleDelete = async (id) => {
    try {
      await axios.post(`https://formulaulybki.ru/api/comments/delete/${id}`);
      fetchData();
    } catch (error) {
      console.log(error);
    }
  ...
  const handlePublish = async (id) => {
    try {
      await axios.post(`https://formulaulybki.ru/api/comments/publish/${id}`);
      fetchData();
    } catch (error) {
      console.log(error);
    }
